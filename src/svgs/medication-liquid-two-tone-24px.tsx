...
const SvgMedicationLiquidTwoTone24Px = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g opacity={0.3}>
      <defs>
        <path
          id="medication_liquid_two_tone_24px_svg__a"
          d="M4 8h10v11H4z"
          opacity={0.3}
        />
      </defs>
      <use
        xlinkHref="#medication_liquid_two_tone_24px_svg__a"
        overflow="visible"
      />
      <clipPath id="medication_liquid_two_tone_24px_svg__b">
        <use
          xlinkHref="#medication_liquid_two_tone_24px_svg__a"
          overflow="visible"
        />
      ...
      <path
        ...
        clipPath="url(#medication_liquid_two_tone_24px_svg__b)"
      />
    </g>
...
export default SvgMedicationLiquidTwoTone24Px;
