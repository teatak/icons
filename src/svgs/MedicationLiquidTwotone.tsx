...
export default createSvg(
  ...
  <g opacity={0.3}>
    <defs>
      <path
        id="medication_liquid_twotone_svg__a"
        d="M4 8h10v11H4z"
        opacity={0.3}
      />
    </defs>
    <use xlinkHref="#medication_liquid_twotone_svg__a" overflow="visible" />
    <clipPath id="medication_liquid_twotone_svg__b">
      <use xlinkHref="#medication_liquid_twotone_svg__a" overflow="visible" />
    </clipPath>
    <path
      d="M4 19h10V8H4zm1-7h2.5V9.5h3V12H13v3h-2.5v2.5h-3V15H5z"
      clipPath="url(#medication_liquid_twotone_svg__b)"
    />
  </g>,
